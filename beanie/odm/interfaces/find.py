...
FindType = TypeVar(
    "FindType", bound=Union["Document", "UnionDoc", "View"]  # type: ignore
)  # only used as type hint, UnionDoc inherit from FindInterface. UnionDoc doesnt inherit from LazyParse so its not compatible with BaseModel would need to inherit LazyParse to UnionDoc

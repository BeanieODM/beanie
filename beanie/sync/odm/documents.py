...
from beanie.sync.odm.queries.update import UpdateMany

from beanie.sync.odm.settings.document import DocumentSettings
from beanie.sync.odm.utils.dump import get_dict
from beanie.sync.odm.utils.relations import detect_link
from beanie.sync.odm.utils.self_validation import validate_self_before
from beanie.sync.odm.utils.state import (
    save_state_after,
    swap_revision_after,
    saved_state_needed,
)
...
if TYPE_CHECKING:
    ...
    from beanie.sync.odm.queries.find import FindOne

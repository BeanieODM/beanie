...
from beanie.odm_sync.interfaces.aggregate import AggregateInterface
from beanie.odm_sync.interfaces.detector import ModelType
from beanie.odm_sync.interfaces.find import FindInterface
from beanie.odm_sync.interfaces.getters import OtherGettersInterface
from beanie.odm_sync.models import (
    InspectionResult,
    InspectionStatuses,
    InspectionError,
)
from beanie.odm_sync.operators.find.comparison import In
from beanie.odm_sync.operators.update.general import (
    CurrentDate,
    Inc,
    Set as SetOperator,
)
from beanie.odm_sync.queries.update import UpdateMany

# from beanie.odm_sync.settings.general import DocumentSettings
from beanie.odm_sync.settings.document import DocumentSettings
from beanie.odm_sync.utils.dump import get_dict
from beanie.odm_sync.utils.relations import detect_link
from beanie.odm_sync.utils.self_validation import validate_self_before
from beanie.odm_sync.utils.state import (
    saved_state_needed,
    save_state_after,
    swap_revision_after,
)
...
class SyncDocument(
    ...
    def __init__(self, *args, **kwargs):
        super(SyncDocument, self).__init__(*args, **kwargs)
    ...
    class Config:
        ...
        @staticmethod
        def schema_extra(
            schema: Dict[str, Any], model: Type["SyncDocument"]
        ) -> None:

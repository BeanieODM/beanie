...
class MigrationSettings:
    def __init__(self, **kwargs: Any) -> None:
        self.direction: str | RunningDirections = (
    ...
    @staticmethod
    def get_env_value(field_name: str) -> str | None:
        if field_name == "connection_uri":
            ...
            # Only work with uppercase environment variables. This avoids
            # relying on lowercase variants and enforces a single canonical
            # naming convention for environment configuration.
            value = os.environ.get(f"BEANIE_{field_name.upper()}")
        return value
...
if __name__ == "__main__":
    # Do not configure logging at module import time; callers should be able to configure logging themselves.
    import logging

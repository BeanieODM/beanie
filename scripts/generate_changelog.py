...
Fetches PRs merged since the previous tag, uses gpt-5-mini to produce
...
def summarise_pr(pr: PullRequest, client: OpenAI) -> str:
    """Use gpt-5-mini to produce a clean one-line changelog summary."""
...
def main() -> None:
    ...
    print("Generating changelog block with gpt-5-mini...")

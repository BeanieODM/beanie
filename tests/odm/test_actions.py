...
from tests.odm.models import (
    ...
    DocumentWithSoftDeleteWithActions2,
    InheritedDocumentWithActions,
    InheritedDocumentWithSoftDeleteWithActions,
)
...
class TestActionsWithSoftDelete:
    @pytest.mark.parametrize(
        "doc_class",
        [
            DocumentWithSoftDeleteWithActions,
    ...
    async def test_actions_soft_delete(self, doc_class):
        test_name = f"test_actions_soft_delete_{doc_class}"
        sample = doc_class(name=test_name)
